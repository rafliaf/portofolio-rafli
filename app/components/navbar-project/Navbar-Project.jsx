...
const NavbarProject = ({ isDarkMode, setIsDarkMode }) => {
  ...
  return (
    <>
      ...
      <nav
        ...
        <li><a className='font-Ovo text-black dark:text-white' href="/#work">My work</a></li>
        <li><a className='font-Ovo text-black dark:text-white' href="/#contact">Contact me</a></li>
        </ul>

        {/* CONTACT, DARK MODE, ICON MENU*/}
        ...
        {/* -- mobile menu -- */}
        <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-gray-200 transition duration-500 dark:bg-darkHover dark:text-white'>
